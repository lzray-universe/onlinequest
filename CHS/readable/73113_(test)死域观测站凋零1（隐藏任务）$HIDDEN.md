# 73113 (test)死域观测站凋零1（隐藏任务）$HIDDEN

(test)死域观测站凋零1$HIDDEN
...
**淘气的兰那罗：**被金色的那菈找到了…这一定是「运气很好」的事情吧？一定是这样。

**淘气的兰那罗：**不过，哼哼，能够找到兰那罗，金色的那菈今天也「运气很好」！
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73113"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73113"
    }
  ],
  "triggerCond": [],
  "execActions": [],
