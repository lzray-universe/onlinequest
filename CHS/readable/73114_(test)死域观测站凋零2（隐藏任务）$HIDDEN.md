# 73114 (test)死域观测站凋零2（隐藏任务）$HIDDEN

(test)死域观测站凋零2$HIDDEN
...
**淘气的兰那罗：**被逮到了…虽然没有用手确实「逮到」，但是既然被看到了…

**淘气的兰那罗：**要什么要什么…「悉听尊便」！唔…这么说没问题吗？
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73114"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73114"
    }
  ],
  "triggerCond": [],
  "execActions": [],
