...
**Npc13394：**（吊水箱的绳子被人做过手脚，舞台上发生的并不只是事故…）
...
**西尔弗：**如果在白淞镇有这样的魔术表演，也会很受欢迎吧。

**娜维娅：**有道理…欸，我要不要学一下呢？能把东西变不见的话，我就不用费力气打扫房间了。

**迈勒斯：**大小姐本来也无需操心这些事，这是我的职责。
...
**Npc13395：**（不知道为什么有钩子掉在这里，大概是其他魔术用的道具吧。）
...
**Npc13398：**（作案者可能从这里离开，但如果要把少女也带走，有点困难…）
...
**旅行者：**（警备队搜查现场之后，损坏的魔术箱保留了下来。这么一看，水箱的冲击力真的很强…）
...
**旅行者：**（箱中之人倒下的位置，如果他不是在箱子里，可能还有机会躲开吧。）
...
**旅行者：**（这个魔术对精度有很高的要求，而轨道就能够让平板车在规定的路线上运行。）
...
**旅行者：**（里面是各种魔术道具和表演用的衣服，很杂乱，好像都是被随便塞进去的。）
...
**旅行者：**（运送魔术箱的关键道具，凶手就是借用了这个去完成自己的计划…）
...
**Npc13674：**（看上去只是个普通的箱子，林尼在表演的时候用某种手法瞬间从舞台移动到了这里面…怎么做到的呢？）
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[1085_18:1.166,7.000,175.704,0.000,191.207,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1085_20:-0.033,2.406,76.504,0.000,179.307,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_EVENTS_ITEM_STATUS",
      "PPFLKMOMKAI": "10113,10105,10104,10103"
    }
  ],
  "triggerCond": [
    {
      ...
      "PPFLKMOMKAI": "[1085_231:-10.871,-45.619,104.343]"
    },
    {
      "BFGALAINLMD": 0,
      "LNHLPKELCAL": [
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1085_67:0.776,7.413,104.789,0.000,214.436,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**[黑屏]** 娜维娅的动作很熟练，一段时间之后，香脆诱人的马卡龙就出炉了。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **分支 1：**
      ...
      **[黑屏]** 娜维娅为了两个马卡龙，又完整地做了一次。

      **[黑屏]** 但之后的讨论，你们并没有收获什么进展…
...
**分支 1：**
  ...
  **芙宁娜：**#但不要止步于此。你是我最看好的对手，{NICKNAME}，可别三两下就投降了，我会很失望的。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1085_115:-74.684,0.032,21.176,0.000,240.600,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
  ...
  "triggerCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LEAVE_SCENE_RANGE",
      "PPFLKMOMKAI": "[1085_115:-74.684,0.032,21.176,0.000,240.600,0.000]"
    }
  ],
  "execActions": [
    {
...
**分支 1：**
  ...
  **派蒙：**#{NICKNAME}，你来决定吧，不管你怎么想，我都会支持你。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1085_304:-41.144,0.512,21.423,0.000,90.205,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
  ...
  "execActions": [
    {
      "LNHLPKELCAL": [
        "4004",
        "10111,10112,10117,10114,10115,10116,10118,10106,10102"
      ],
      "PAINLIBBLDK": "QUEST_EXEC_UNLOCK_EVENTS_ITEM"
    }
  ],
