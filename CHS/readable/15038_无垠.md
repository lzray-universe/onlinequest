...
- **推荐等级**：40
- **任务奖励**：
  - 冒险阅历×425，原石×60，摩拉×38100，「角逐」的指引×5，Item_362407×1，「余音」×1，特训回顾×1，大英雄的经验×4，精锻用魔矿×8
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[20272_49:4605.405,-0.626,-180.467,0.000,174.831,0.000]"
    ],
    "NOCCOBOFKHP": 20272,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "EMAIGPLHEJH": "QUEST_GUIDE_LAYER_SCENE",
    "GGJOHCAJAPP": 0,
    "HFNCMGLBNGO": "[3_310600198:-425.288,299.459,1610.193,0.000,55.172,0.000]",
    "IDLNFDCEJLG": "QUEST_GUIDE_AREA_STYLE_DEFAULT",
    "KCFINIEBBBG": 0,
    "KEDGDANLBHP": "",
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_310600195:-380.752,342.779,1467.800]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**分支 1：**
  ...
  **派蒙：**#虽然听不懂你在讲什么，但{NICKNAME}总有办法的。

  **派蒙：**#从我遇到{M#他}{F#她}开始，每天都很开心。就算旅途中有数不清的困难，{M#他}{F#她}也总能闯出一条路来。
