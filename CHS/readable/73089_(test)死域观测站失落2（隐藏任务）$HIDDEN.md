# 73089 (test)死域观测站失落2（隐藏任务）$HIDDEN

(test)死域观测站失落2$HIDDEN
...
**淘气的兰那罗：**咚咚！是兰那罗！既然被找到了，就要「光明正大」地登场，然后，「光明正大」地退场，没错！

**淘气的兰那罗：**被找到可不是输掉游戏！那菈「成功地」找到兰那罗，兰那罗「成功地」被找到，都赢！嘿嘿。
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73089"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73089"
    }
  ],
  "triggerCond": [],
  "execActions": [],
