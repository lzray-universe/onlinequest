# 73051 (test)死域观测站失落1（隐藏任务）$HIDDEN

(test)死域观测站失落1$HIDDEN
...
**淘气的兰那罗：**被看到了吗？那菈和夜晚活动的鸟一样，有很厉害的眼睛。

**淘气的兰那罗：**不过…听说有些地方的鸟到了夜晚，眼睛会冒红光！可怕可怕！
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73051"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73051"
    }
  ],
  "triggerCond": [],
  "execActions": [],
