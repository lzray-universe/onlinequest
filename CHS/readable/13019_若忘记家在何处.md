...
- **推荐等级**：40
- **任务奖励**：
  - 冒险阅历×875，摩拉×53900，大英雄的经验×6，精锻用魔矿×12
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[3_330201375:-520.148,227.346,2693.918,0.000,261.102,0.000]"
    ],
    "NOCCOBOFKHP": 3,
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_330201474:-550.417,201.417,2942.445]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_330201479:-593.550,211.467,2983.429,0.000,268.165,0.000]",
      "35"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
```json
{
  ...
  "triggerCond": [
    ...
    },
    {
      ...
      "PPFLKMOMKAI": "Q13019DeadZoneNahida"
    }
  ],
  "execActions": [],
  "guide": {
...
```json
{
  ...
  "triggerCond": [
    ...
    },
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LEAVE_SCENE_RANGE",
      "PPFLKMOMKAI": "Q13019HidePlayerWatchPos"
    }
  ],
  "execActions": [],
  "guide": {
...
**[黑屏]** 见同伴恢复意识，这里的蕈兽也放下了对你们的戒备。

**[黑屏]** 你们顺利汇合，纳西妲也变回了平时的样子。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_331500126:583.111,283.714,2508.252]",
      "25"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_331500125:596.735,290.933,2534.805]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
