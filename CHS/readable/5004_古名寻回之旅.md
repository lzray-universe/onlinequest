...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[3_350100017:-2134.615,248.976,8425.163,0.000,130.275,0.000]",
      "40"
    ],
    "NOCCOBOFKHP": 3,
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_8698:-2119.158,241.667,8482.317]",
      "25"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "triggerCond": [
    ...
    },
    {
      ...
      "PPFLKMOMKAI": "[3_8215:-2271.591,270.043,8626.934]"
    }
  ],
  "execActions": [],
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_8215:-2271.591,270.043,8626.934]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_9481:-2271.619,271.635,8619.961,0.000,12.688,0.000]",
      "10"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
  ...
  **分支 1：**
    ...
    **分支 1：**
      ...
      **分支 1：**
        ...
        **恰斯卡：**#深渊一旦侵蚀到体内，就会有一部分与内脏同化。就算{NICKNAME}有净化的力量，也不可能完全祛除深渊带来的影响。

        **恰斯卡：**#不过多亏了{NICKNAME}，你受深渊的影响还不深。我可以教给你一些对抗它的方法，比如降低呼吸频率、有意识地控制心神稳定。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_350100018:-2138.317,250.303,8423.401,0.000,347.041,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
