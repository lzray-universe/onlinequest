...
- **后接主任务**：3017
- **任务奖励**：
  - 冒险阅历×900，摩拉×36000，大英雄的经验×3，精锻用魔矿×6
...
**纳西妲：**#没什么没什么，{NICKNAME}，你先选一个想要占卜的主题吧。
...
**纳西妲：**#而怎么讲才能让塞塔蕾动摇，就交给你了，{NICKNAME}，我相信你。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **纳西妲：**#做得不错，{NICKNAME}，塞塔蕾应该没察觉出什么蹊跷。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **纳西妲：**#{NICKNAME}的「攻势」非常巧妙，{PLAYERAVATAR#SEXPRO[INFO_MALE_PRONOUN_HE|INFO_FEMALE_PRONOUN_SHE]}才是功劳最大的那个。
...
**分支 1：**
  ...
  **纳西妲：**#我觉得{NICKNAME}说得没错，的确比平时安静了。
...
**派蒙：**（test）可考虑的对话，主要凸显环境的不对劲，整个街道都没有人
