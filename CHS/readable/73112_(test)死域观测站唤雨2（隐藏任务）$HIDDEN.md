# 73112 (test)死域观测站唤雨2（隐藏任务）$HIDDEN

(test)死域观测站唤雨2$HIDDEN
...
**淘气的兰那罗：**欸？被、被发现了吗？该怎么办才好呢…啊，对了…这样就行了。

**淘气的兰那罗：**好那菈，什么都没有看见，这里没有兰那罗！没！有！
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73112"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73112"
    }
  ],
  "triggerCond": [],
  "execActions": [],
