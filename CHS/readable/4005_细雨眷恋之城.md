...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[3_340100051:3489.546,429.734,4609.812,0.000,118.699,0.000]"
    ],
    "NOCCOBOFKHP": 3,
...
**派蒙：**#你好，我是派蒙，这位是{NICKNAME}。你好像很自豪呢，有这么一位潜水员弟弟。
...
**分支 1：**
  ...
  **林尼：**#对了菲米尼，我跟{NICKNAME}一起又收集了些魔术口袋的材料，你那边如何？
  ...
  **分支 1：**
    ...
    **分支 1：**
      ...
      **林尼：**#不知道能不能麻烦{NICKNAME}再跑一趟了，帮忙把这些材料送到博蒙特工坊，交给那里的老板。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **「公子」：**#欸？{NICKNAME}！派蒙！居然会在枫丹遇到你们，太不可思议了！
    ...
    **分支 1：**
      ...
      **派蒙：**#你说的那种有趣，我们可不怎么喜欢，旅途还是顺顺利利为好，你说对吧，{NICKNAME}。
      ...
      **分支 1：**
        ...
        **「公子」：**#别打岔，我和{NICKNAME}能见一面的机会可是很难得的，你们先在那边等我一会儿。

        **图昂：**你小子…是你跑来找我们讨债，现在又要我们站在一边等你聊天…

        **图昂：**给我听好了，小子，我们现在就要还钱！你给我过来！

        **「公子」：**#我说了别打岔…哦对了，{NICKNAME}，上次我带冬妮娅和托克去冰钓的时候，托克还说…
  ...
  "triggerCond": [
    {
      ...
      "PPFLKMOMKAI": "[3_340100049:3601.654,428.195,4581.615,0.000,70.803,0.000]"
    },
    {
      "BFGALAINLMD": 0,
      "LNHLPKELCAL": [
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340100049:3601.654,428.195,4581.615,0.000,70.803,0.000]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340100043:3602.114,428.195,4578.541,0.000,343.816,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
    ...
    **分支 1：**
      ...
      **分支 1：**
        ...
        **分支 1：**
          ...
          **「公子」：**#而且，只是拜托{NICKNAME}帮我保管一下，我有空会找你们来取的。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340100055:3419.100,446.167,4563.300,0.000,203.383,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340300173:3545.622,495.261,4548.838]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340200110:3793.502,491.209,3800.054]",
      "25"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340200008:3482.848,460.579,3650.502,0.000,316.215,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**林尼：**#你们果然没有爽约啊，{NICKNAME}和派蒙，见到你们可真好。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1085_28:-8.347,-1.748,56.702,0.000,95.801,0.000]"
    ],
    "NOCCOBOFKHP": 1085,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**派蒙：**#喂，{NICKNAME}…我们是不是该跟旁边那个人搭个话比较好，没什么人的情况下，座位挨在一起好尴尬啊…
...
**分支 1：**
  ...
  **派蒙：**#你好，先生，我是派蒙，这位是{NICKNAME}，我们都刚刚来到枫丹。
  ...
  **[黑屏]** 一段时间后，观众陆续入场了，演出终于拉开帷幕。

  **派蒙：**#哦！{NICKNAME}，灯黑下来了，是不是演出马上就开始了！
...
**分支 1：**
  ...
  **派蒙：**#喂喂，{NICKNAME}，你说林尼他是不是真的会用法术啊。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **芙宁娜：**#没想到{M#他}{F#她}竟然能在林尼的帮助下，和我打成平手，呵呵，最没意思的就是平手。
    ...
    **那维莱特：**#{NICKNAME}，芙宁娜女士将你视为「对手」，我们且无视她浮夸的言辞，仅征求你的意见…
    ...
    **分支 1：**
      ...
      **分支 1：**
        ...
        **林尼：**#多亏了你愿意成为我的「代理人」，{NICKNAME}，非常感谢。现在我能依靠的，只有你们了。
