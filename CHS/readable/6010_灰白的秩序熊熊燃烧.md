...
**分支 1：**
  ...
  **分支 1：**
    ...
    **[黑屏]** 奈芙尔狠狠教训了这帮人一顿，才把他们放走，你们也随之离开这里。
...
**奈芙尔：**#有道理。还记得我们在酒馆得到的消息吗，{NICKNAME}？被清理掉的狂猎，比执灯人的记载要多。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_11752:3758.803,218.543,9208.004]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_11753:2242.528,200.262,9518.904,0.000,59.810,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_1:1757.069,225.840,9495.331,0.000,241.910,0.000]"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**菈乌玛：**#…{NICKNAME}来不及赶回来，直接去星砂滩了。

**雅珂达：**#欸？星砂滩，那里可是炮击目标！{M#他}{F#她}去干什么？

**伊涅芙：**危险评估等级，最高。

**爱诺：**也就是说，如果我们拦不下这炮的话…

**奈芙尔：**#{M#他}{F#她}已经展现了{M#他}{F#她}的决心…

**菈乌玛：**#我们不能辜负{M#他}{F#她}的信任，快走。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_4:1693.910,223.149,9430.492]",
      "10"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_5:1670.301,224.123,9422.843]",
      "30"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_2:1649.122,224.059,9445.048,0.000,182.109,0.000]",
      "20"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_9:1622.733,255.726,9395.583]"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_8:1654.169,295.876,9477.730]"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_7:1649.273,227.689,9472.140]"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_6:1653.253,228.490,9495.651]",
      "30"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[20278_3:1652.411,228.486,9499.277]"
    ],
    "NOCCOBOFKHP": 20278,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_11740:2136.161,109.109,11208.750,0.000,244.948,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
