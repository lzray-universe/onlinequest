...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[3_330400515:-1901.731,243.198,2490.824,0.000,70.874,0.000]",
      "10"
    ],
    "NOCCOBOFKHP": 3,
...
**柯莱：**#啊——{NICKNAME}、派蒙！你们也在啊！太好了，有熟人在…
...
**[黑屏]** 你们冲进走廊，尝试进入卢西恩的房间。房门却同样丝毫未动…
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[1098_1:-3.458,0.589,-69.965,0.000,183.472,0.000]"
    ],
    "NOCCOBOFKHP": 1098,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**艾梅莉埃：**#{NICKNAME}，我先保护好现场。治安官那边，就有劳你来联系了。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[1097_3:-112.632,0.555,-69.011,0.000,152.154,0.000]",
      "5"
    ],
    "NOCCOBOFKHP": 1097,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
**[黑屏]** 你们一起进入了席尔万的房间。席尔万看起来已经冷静了许多…
...
```json
{
  ...
  "execActions": [
    ...
    },
    {
      "LNHLPKELCAL": [
        "3",
        "133304603,1;133304395,1;133304191,1"
      ],
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_330400554:-1964.049,203.132,2566.785]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**柯莱：**#艾梅莉埃！夏姆先生说，一会儿想请你和{NICKNAME}讨论一下守夜的事…
...
**分支 1：**
  ...
  **夏姆：**#是，我们商量下来，觉得接下来席尔万被袭击的可能性最大。{NICKNAME}的身手应该是这里最好的…

  **夏姆：**而艾梅莉埃的知识，能防患于未然…所以我想请你们，守在席尔万隔壁。

  **旅行者：**我没什么问题，艾梅莉埃呢？

  **艾梅莉埃：**#很合理的配置。那今晚就拜托你了，{NICKNAME}。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[1098_2:-0.964,0.555,-67.918,0.000,61.645,0.000]"
    ],
    "NOCCOBOFKHP": 1098,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**席尔万：**…你们要守的房间是在隔壁吧。我可不希望基里亚一见你们在这就溜了。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[1096_3:16.876,0.060,9.251,0.000,256.075,0.000]",
      "5"
    ],
    "NOCCOBOFKHP": 1096,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
...
**分支 1：**
  ...
  **夏姆：**#{NICKNAME}，我已经按你们说的，让手下去造势了，外面的人群也散开了…不过这究竟是怎么回事？
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_330400587:-1886.497,243.812,2492.028,0.000,339.202,0.000]",
      "5"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_ENABLE",
