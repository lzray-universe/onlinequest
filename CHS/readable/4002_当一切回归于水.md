...
- **推荐等级**：40
- **前置主任务**：4001, 74668
- **后接主任务**：4003, 4011, 74034, 74037, 74650, 74667, 74800
- **任务奖励**：
  - 冒险阅历×1325，原石×30，摩拉×58200，奔流不息的记忆×1，大英雄的经验×5，精锻用魔矿×11
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_4498:3686.354,440.185,4352.712]",
      "20"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_4747:3543.000,383.509,4265.175]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[3_4719:3530.441,381.767,4253.857]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**[黑屏]** 一段时间之后，困惑且惊愕的玛塞勒被送上了「被指控者」的位置。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_6016:3533.735,385.140,4242.355]",
      "0"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_EVENTS_ITEM_STATUS",
      "PPFLKMOMKAI": "10101,10102,10103,10104,10112"
    }
  ],
  "triggerCond": [
    {
...
**Npc13411：**（堆放着装有原始胎海之水以及「乐斯」的瓶子，应该能用来证明这个设施的用途。）
...
**Npc13412：**（有很多女性物品被分别收纳在这里，应该都属于那些失踪的少女…）
...
**Npc13413：**（从刚刚找到的实验报告上看，瓦谢为了拯救自己的恋人，不惜将许多少女溶解。）
...
**Npc13414：**（除了调查报告，还有大量的研究用书籍，这里的实验已经进行了很长时间。）
...
**Npc13410：**（装满了原始胎海之水的水池，由此诞生了无数的罪恶…）
...
**Npc13427：**（除了调查报告，还有大量的研究用书籍，这里的实验已经进行了很长时间。）

**Npc13427：**（但这里没有和瓦谢身份相关的线索…）
...
**Npc13423：**（装满了原始胎海之水的水池，由此诞生了无数的罪恶…）

**Npc13423：**（好像没有其他值得注意的地方了。）
...
**Npc13426：**（从刚刚找到的实验报告上看，瓦谢为了拯救自己的恋人，不惜将许多少女溶解。）

**Npc13426：**（但这里没有和瓦谢身份相关的线索…）
...
**Npc13424：**（堆放着装有原始胎海之水以及「乐斯」的瓶子，应该能用来证明这个设施的用途。）

**Npc13424：**（好像没有其他值得注意的地方了。）
...
**那维莱特：**#那么，在由我复原整个「少女连环失踪案」的真相之前，请{NICKNAME}将证据提交给警备队。
...
**玛塞勒：**#{NICKNAME}！喂！{NICKNAME}！

**派蒙：**唔欸！这不是玛塞勒么，你又跑过来是要做什么！

**埃斯蒙德：**你抗拒执法，当心罪加一等！

**玛塞勒：**#不，等等，我只是想和{NICKNAME}说句话，绝不是要逃跑的意思，求求你们，求求你们给我一点时间…
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **玛塞勒：**#求求你们，给我一个机会见她，让{NICKNAME}带我去见她一面，这是我一生最后的请求，事后不论怎么处置我都可以…
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340200012:3453.145,459.001,3680.335,0.000,120.000,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340200015:3460.879,492.000,3669.608]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**[黑屏]** 后来，警备队发现少女连环失踪案的罪魁祸首玛塞勒似乎被夺去了灵魂。\n 不过最后医生还是断定他死于惊吓过度。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_340200019:3567.073,445.895,4445.939,0.000,227.634,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_TARGET",
    "LNHLPKELCAL": [
      "[3_340300038:2640.366,462.167,4273.290,0.000,282.125,0.000]",
      "20"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
**那维莱特：**#如果{M#她}{F#他}来过枫丹，那想必{M#她}{F#他}一定很尊重枫丹的法律，与歌剧院无缘。
  ...
  "finishCond": [
    {
      ...
      "PPFLKMOMKAI": "[3_340300038:2640.366,462.167,4273.290,0.000,282.125,0.000]"
    }
  ],
  "triggerCond": [],
  "execActions": [
