...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "Q302018_N1053_guide_Q302017_N1058"
    ],
    "NOCCOBOFKHP": 3,
...
```json
{
  ...
  "execActions": [
    ...
    {
      "LNHLPKELCAL": [
        "133303132,133303133,133303342,133303344",
        "0"
      ],
      "PAINLIBBLDK": "QUEST_EXEC_UNREGISTER_DYNAMIC_GROUP"
    }
...
**[黑屏]** 众人四散开来，在沙漠中央努力地挖掘。

**[黑屏]** 不过好在没花太多时间，就从附近的沙堆里挖出了另一台仪器。
...
**分支 1：**
  ...
  **分支 1：**
    ...
    **[黑屏]** 一行人回到阿如村，各自回屋休息，算是为明天交换人质做准备。

    **[黑屏]** 但这件事成功概率有多高？又能否顺利实行？一切，都还是未知数…
