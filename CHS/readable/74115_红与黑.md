...
**分支 1：**
  ...
  **[黑屏]** 派蒙开始胡吃海喝，飞快席卷了一份半散发着微妙气味的「鱼鱼咏唱派」。\n半小时后…她捂着肚子从外面回来。

  **托萝莎：**怎么突然走掉了？不够的话我这里还有，我做了许多。

  **派蒙：**#谢…谢谢托萝莎！我只是去休息了一下，真的不用了！还有半份我都没吃完…{NICKNAME}，快先收起来吧，下次再吃…
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_5641:2508.042,250.007,4585.646,0.000,320.000,0.000]",
      "15"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
**派蒙：**#（好…好办法！{NICKNAME}，快找找包里有没有能用上的「佐料」！）
...
**[黑屏]** 伴随着「吃饭时间到！」的吆喝，「优雅餐具商会」的众人吃下了带着「佐料」的食物。\n没过多久，他们脸上纷纷浮现了微妙的表情，捂着肚子陆陆续续朝出口奔去。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_5642:2498.972,251.737,4603.415,0.000,214.021,0.000]",
      "40"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_5643:2516.050,250.294,4599.792,0.000,320.000,0.000]",
      "40"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_5644:3491.080,283.692,4556.493,0.000,100.000,0.000]",
      "30"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_5645:3512.280,285.124,4558.855,0.000,317.393,0.000]",
      "40"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
  ...
  "execActions": [
    {
      "LNHLPKELCAL": [
        "74113",
        "11307,11308,11315,11324,11326,11327,11328,11329"
      ],
      "PAINLIBBLDK": "QUEST_EXEC_UNLOCK_EVENTS_ITEM"
    }
  ],
...
**派蒙：**#比如，在我烦恼吃很多史莱姆要变胖的时候，{NICKNAME}就会说，派蒙就算胖了也很可爱，像这样的话。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_POINT",
    "LNHLPKELCAL": [
      "[3_5649:3516.812,451.218,4655.091,0.000,254.490,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**托萝莎：**#太棒了！{NICKNAME}推理的没错，事情就是这样，首先到达现场的是我…
...
**旅行者：**然后是老子！老子叫「勇猛落落莓」，是一个犯罪团伙的四十二当家。

**旅行者：**因为要对报社打击报复，所以老子打算去把亚瑟先生一刀捅个对穿。

**旅行者：**但老子到的时候，亚瑟先生已经不在了。老子很生气，但没办法，只好把刀插在底座上吓吓报社，然后老子就走了，接着…
...
**派蒙：**#如果{NICKNAME}也被人冤枉，我一定也想要为{NICKNAME}报仇的！哎呀！我不敢想那些…
