# 73111 (test)死域观测站唤雨1（隐藏任务）$HIDDEN

(test)死域观测站唤雨1$HIDDEN
...
**淘气的兰那罗：**呼——终于可以出来啦！不愧是兰那罗的朋友，一下子就被找到啦！

**淘气的兰那罗：**原本还想和那菈多玩一下…之后还有机会和那菈玩吗？这时候如果是那菈，会说什么呢？「咱们走着瞧！」对吗？
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved1_73111"
    }
  ],
  "triggerCond": [],
  "execActions": [],
  ...
  "finishCond": [
    {
      ...
      "PAINLIBBLDK": "QUEST_CONTENT_LUA_NOTIFY",
      "PPFLKMOMKAI": "smokeObserved2_73111"
    }
  ],
  "triggerCond": [],
  "execActions": [],
