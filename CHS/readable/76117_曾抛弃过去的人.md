...
- **后接主任务**：76129
- **任务奖励**：
  - 冒险阅历×150，摩拉×20000，大英雄的经验×3，破旧的「玩偶」×1
...
**分支 1：**
  ...
  **雅珂达：**#{NICKNAME}，派蒙，既然你们身手这么好，不然帮我来做委托？到时候钱平分。

  **派蒙：**#委、委托啊…你问{NICKNAME}，{M#他}{F#她}对这个最在行了！
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_360700171:2099.183,200.000,9558.525,0.000,66.045,0.000]",
      "15"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
  ...
  "triggerCond": [
    {
      ...
      "PPFLKMOMKAI": "[3_360700171:2099.183,200.000,9558.525,0.000,66.045,0.000]"
    }
  ],
  "execActions": [
    {
...
**雅珂达：**#嗯，这一份是给你的，{NICKNAME}，刚才也谢谢你了。
...
```json
{
  ...
  "guide": {
    ...
    "KNMAMMFJAOB": "QUEST_GUIDE_STYLE_NONE",
    "LNHLPKELCAL": [
      "[3_360700170:2021.016,206.878,9783.601,0.000,234.574,0.000]"
    ],
    "NOCCOBOFKHP": 3,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
