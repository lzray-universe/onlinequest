...
- **后接主任务**：4025
- **任务奖励**：
  - 冒险阅历×1425，原石×30，摩拉×62225，星间之泪×1，大英雄的经验×6，精锻用魔矿×11
...
```json
{
  ...
  "guide": {
    ...
    "LNHLPKELCAL": [
      "[20202_1:34.226,119.589,37.334,0.000,184.829,0.000]"
    ],
    "NOCCOBOFKHP": 20202,
    "OFEBJNGBEPL": "QUEST_GUIDE_AUTO_NONE",
    "PAINLIBBLDK": "QUEST_GUIDE_LOCATION"
...
**芙宁娜：**#（{M#他}{F#她}说得没错，如果是{M#他}{F#她}的话，倾诉应该也没关系吧？）
...
**分支 1：**
  ...
  **那维莱特：**#{NICKNAME}，如今谕示机已经失去作用了，为了执行正义，我需要一位「处刑人」。
